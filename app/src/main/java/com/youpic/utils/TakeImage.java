...
public class TakeImage extends Activity
{
	...
	private final String capture_dir = Environment.getExternalStorageDirectory() + "/VoyageCentral/Images/";
	Activity activity;
	...
	public static final int CAMERA_PERMISSION_REQUEST_CODE = 3,CROP_IMAGE = 101;
	Uri imageFileUri;
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		...
		if (mCapturedImageURI != null) {
			savedInstanceState.putString(CAPTURED_PHOTO_URI_KEY, imageFileUri.toString());
		}

		/*UserDataModel userDataModel=new UserDataModel();
		userDataModel.setCurrentUserType(UserDataSingleton.getUserInstance().getCurrentUserType());
		userDataModel.setNotification(UserDataSingleton.getUserInstance().getNotification());

		savedInstanceState.putParcelable("userDataModel",userDataModel);*/
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		if (savedInstanceState.containsKey(CAPTURED_PHOTO_URI_KEY)) {
			imageFileUri = Uri.parse(savedInstanceState.getString(CAPTURED_PHOTO_URI_KEY));
		}
		/*if (savedInstanceState.containsKey("userDataModel")) {
			UserDataModel userDataModel=savedInstanceState.getParcelable("userDataModel");
			UserDataSingleton.getUserInstance().setCurrentUserType(userDataModel.getCurrentUserType());
			UserDataSingleton.getUserInstance().setNotification(userDataModel.getNotification());
		}*/
...
//				imageFileUri = FileProvider.getUriForFile(TakeImage.this,BuildConfig.APPLICATION_ID + ".provider",new File(path));
				 Uri imageFileUri = FileProvider.getUriForFile(TakeImage.this, BuildConfig.APPLICATION_ID+".provider",new File(path));
